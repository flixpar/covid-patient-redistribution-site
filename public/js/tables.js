...
const column_descriptions = {
	"Total Sent": "Total number of patients that should be sent to another location according to our model.",
	"Total Received": "Total number of patients that would be received from another location under our model.",
	...
	"Capacity": "Number of COVID-dedicated beds in the location.",
	"New Patients": "Forecasted number of people who need to be admitted to the location on a given day.",
	"Optimal Transfers (Sent)": "Number of patients that should be sent to another location on a given day according to our model.",
	"Optimal Transfers (Received)": "Number of patients that would be received from another location on a given day under our model.",
	"Active Patients (Optimal Transfers)": "Expected number of patients in a given location on a given day, assuming optimal transfers.",
	"Active Patients (Without Optimal Transfers)": "Expected number of patients in a given location on a given day, according to the data/forecasts.",
